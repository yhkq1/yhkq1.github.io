!(function (e, t) {
    ...
    function l(e) {
        ...
        return function () {
            ...
            return a(
                this,
                t ? ((n = c(this).constructor), Reflect.construct(i, arguments, n)) : i.apply(this, arguments)
            );
        };
    }
    var f = !1,
    ...
    function v() {
        for (var e in s) if (s[e]) return (f = !0);
        return (f = !1);
    }
    function h() {
    ...
    function E() {
        ...
        (function (e, t) {
            ...
            void 0 !== (u = document).hidden
                ...
                : void 0 !== u.mozHidden
                  ? ((o = "mozHidden"), (c = "mozvisibilitychange"), (r = "mozVisibilityState"))
                  : void 0 !== u.msHidden
                    ? ((o = "msHidden"), (c = "msvisibilitychange"), (r = "msVisibilityState"))
                    : void 0 !== u.webkitHidden &&
                      ((o = "webkitHidden"), (c = "webkitvisibilitychange"), (r = "webkitVisibilityState")),
            ...
            (x = window.setInterval(function () {
                ...
                a ||
                    ...
                    U(),
                    "function" == typeof z.ondevtoolclose && ((e = f), !v() && e && z.ondevtoolclose()));
            }, z.interval)),
    ...
    function q(e) {
        for (
            var t = (function (e, t) {
                    ...
                    for (
                        var n = 1732584193, i = -271733879, o = -1732584194, r = 271733878, c = 0;
                        c < e.length;
                        c += 16
                    ) {
                        var u = n,
    ...
    var Y,
        $ = (function () {
            function e(n) {
                ...
                t(this, e),
                    ...
                    (this.type = i),
                    (this.enabled = n),
                    this.enabled && ((i = this), j.push(i), this.init());
            }
            return (
                i(e, [
                    {
        ...
        J =
            ((O = (function () {
                ...
                var e = l(n);
                function n() {
                    return t(this, n), e.call(this, { type: Y.RegToString, enabled: g || m });
                }
                return (
                    i(n, [
                        {
            ...
            (function () {
                ...
                var e = l(n);
                function n() {
                    return t(this, n), e.call(this, { type: Y.DefineId });
                }
                return (
                    i(n, [
                        {
        ...
        Q = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.Size, enabled: !w && !D });
            }
            return (
                i(n, [
                    {
    ...
    var ee,
        ...
        re = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.DateToString, enabled: !k });
            }
            return (
                i(n, [
                    {
        ...
        ce = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.FuncToString, enabled: !k && !S });
            }
            return (
                i(n, [
                    {
        ...
        ue = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.Debugger, enabled: k || S });
            }
            return (
                i(n, [
                    {
        ...
        ae = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.Performance, enabled: P });
            }
            return (
                i(n, [
                    {
        ...
        le = (function () {
            ...
            var e = l(n);
            function n() {
                return t(this, n), e.call(this, { type: Y.DebugLib });
            }
            return (
                i(n, [
                    { key: "init", value: function () {} },
                        ...
                        value: function () {
                            ...
                            (!0 ===
                                (null == (e = null == (e = window.eruda) ? void 0 : e._devTools)
                                    ? void 0
                                    : e._isShow) ||
                                (window._vcOrigConsole && window.document.querySelector("#__vconsole.vc-toggle"))) &&
                                this.onDevToolOpen();
                        }
                    }
                ]),
    ...
    function se(t) {
        (function (t) {
            ...
            "function" == typeof z.ondevtoolclose &&
                !0 === z.clearIntervalWhenDevOpenTrigger &&
                ((z.clearIntervalWhenDevOpenTrigger = !1),
                ...
                if (
                    ...
                    q(
                        (function (e) {
                            ...
                            return "" !== (t = "" === t && "" !== n ? "?".concat(n.split("?")[1]) : t) &&
                                void 0 !== t &&
                                ((n = new RegExp("(^|&)" + e + "=([^&]*)(&|$)", "i")),
                                null != (e = t.substr(1).match(n)))
                                ? unescape(e[2])
                                : "";
                        })(z.tkName)
                    ) === z.md5
    ...
    return (
        ...
        "undefined" != typeof document &&
            (te = document.querySelector("[disable-devtool-auto]")) &&
            ((oe = {}),
